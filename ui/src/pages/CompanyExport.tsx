...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://autarch.ai) package.");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Autarch.OS](https://autarch.ai) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Autarch.OS](https://autarch.ai) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
