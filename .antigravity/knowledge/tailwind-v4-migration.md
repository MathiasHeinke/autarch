...
> [!WARNING]
> Antigravity nutzt aktuell **Tailwind v3.4.11**. Dieses File dokumentiert Tailwind v4.x
...
@theme {
  ...
  /* Antigravity Dark Mode Palette (P3 oklch) */
...
| Was | v3 | v4 | Impact für Antigravity |
|---|---|---|---|
| farben | `bg-zinc-950` (sRGB) | `bg-zinc-950` (P3 oklch) | Farben können minimal anders aussehen |
| `@apply` | Überall | Nur in `@layer` Kontexten | Prüfen ob Antigravity `@apply` außerhalb nutzt |
| `darkMode: 'class'` | In config | `@variant dark (&.dark)` | Antigravity muss Dark Mode Variant prüfen |
| Arbitrary properties | `[&>*]:` | Weiterhin verfügbar | 🟢 Kein Impact |
| JIT | Default | Immer | 🟢 Kein Impact |

---

## Antigravity-spezifische Entscheidung
