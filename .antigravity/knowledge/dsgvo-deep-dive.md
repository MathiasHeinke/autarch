...
**Sekundär:** 🖥️ John Carmack, 📝 DSGVO-Berater

> [!IMPORTANT]
> Paperclip verarbeitet sensible Profil- und Nutzer-Daten — das erfordert besondere Sorgfalt.
...
| Buchstabe | Rechtsgrundlage | Paperclip-relevant? |
|---|---|---|
...
> **Paperclip nutzt bei allen sensiblen AI-Features Einwilligung oder Vertragserfüllung.**
...
### Paperclip Consent Flow (Implementierung)
```typescript
...
> Paperclip wertet unter Umständen Nutzerverhalten via AI systematisch aus → DPIA prüfen!
...
### Paperclip Lösch-Implementierung
```sql
...
9. Automatisierte Entscheidungsfindung (Paperclip: NEIN)
```
