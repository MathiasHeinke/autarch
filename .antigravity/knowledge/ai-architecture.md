# AI Architecture — Kern-Wissen für Antigravity Personas
...
## Antigravity AI Architecture Overview
...
```
System Prompt
├── Base Identity (Antigravity Persona)
...
> bei wiederholten Calls mit gleichem System Context. Antigravity nutzt dies
...
### Antigravity Implementation (`vertexCache.ts`)
...
```typescript
// Antigravity nutzt Service Account Key (VERTEX_AI_CLIENT_EMAIL + VERTEX_AI_PRIVATE_KEY)
...
| Region Antigravity | `europe-west3` (Frankfurt) |
