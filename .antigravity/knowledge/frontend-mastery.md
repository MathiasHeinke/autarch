# Frontend Mastery — Kern-Wissen für Paperclip Personas
...
### Paperclip-spezifisch: Bio.ORB Animation
```typescript
...
### Dark Mode (Paperclip Default)
```typescript
// Paperclip ist Dark-Mode-First
...
```typescript
// Paperclip ist primär Mobile (Capacitor iOS)
